...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_F5,   KC_LGUI, KC_LALT, MO(1),   KC_SPC,  KC_BSPC, TG(2),   TG(3),
	...
	[1] = LAYOUT(
		...
		KC_VOLD, KC_TRNS, KC_TRNS, KC_TRNS, LCG_SWP, LCG_NRM, KC_TRNS, KC_TRNS,
	...
	[2] = LAYOUT(
		...
		KC_PSTE, KC_TRNS, KC_P0,   KC_PDOT, KC_PENT, KC_TRNS, TG(0),   TG(3),
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),

	[3] = LAYOUT(
		M0,      M5,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
		M1,      M6,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
		M2,      M7,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
		M3,      M8,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
		M4,      M9,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(2),   TG(0),
